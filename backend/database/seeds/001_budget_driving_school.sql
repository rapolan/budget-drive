...
-- created_by/updated_by explicitly set to the seeded admin user (matching
-- the students seed's identical convention) so the Lessons page's History
-- column (AuditColumn) has a name to resolve instead of "Unknown" - see
-- lessonService.ts's getAllLessons/getLessonById LEFT JOIN to users.
INSERT INTO lessons (id, tenant_id, enrollment_id, instructor_id, vehicle_id, date, start_time, end_time, duration, status, lesson_type, cost, student_performance, instructor_rating, completion_verified, notes, created_by, updated_by) VALUES
-- Student 3 (Mia Torres): 1 completed (~2 hrs), 1 upcoming scheduled
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-00000000000a', (SELECT id FROM vehicles WHERE license_plate = '7ABC123'), CURRENT_DATE - INTERVAL '15 days', '09:00', '11:00', 120, 'completed', 'behind_wheel', 70.00, 'good', 5, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-00000000000a', (SELECT id FROM vehicles WHERE license_plate = '7ABC123'), CURRENT_DATE + INTERVAL '3 days', '09:00', '11:00', 120, 'scheduled', 'behind_wheel', 70.00, NULL, NULL, false, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),

-- Student 4 (Leo Whitfield): 3 completed lessons totaling 6 hours - meets required hours, enrollment still active
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-00000000000c', (SELECT id FROM vehicles WHERE license_plate = '7DEF456'), CURRENT_DATE - INTERVAL '30 days', '09:00', '11:00', 120, 'completed', 'behind_wheel', 70.00, 'good', 5, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-00000000000c', (SELECT id FROM vehicles WHERE license_plate = '7DEF456'), CURRENT_DATE - INTERVAL '20 days', '09:00', '11:00', 120, 'completed', 'behind_wheel', 70.00, 'good', 5, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-00000000000c', (SELECT id FROM vehicles WHERE license_plate = '7DEF456'), CURRENT_DATE - INTERVAL '10 days', '13:00', '15:00', 120, 'completed', 'road_test_prep', 85.00, 'excellent', 5, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),

-- Student 5 (Ruby Sandoval): completed enrollment - 3 completed lessons in the past, before completion
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-00000000000a', (SELECT id FROM vehicles WHERE license_plate = '7ABC123'), CURRENT_DATE - INTERVAL '55 days', '09:00', '11:00', 120, 'completed', 'behind_wheel', 70.00, 'good', 5, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-00000000000a', (SELECT id FROM vehicles WHERE license_plate = '7ABC123'), CURRENT_DATE - INTERVAL '40 days', '09:00', '11:00', 120, 'completed', 'behind_wheel', 70.00, 'excellent', 5, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-00000000000a', (SELECT id FROM vehicles WHERE license_plate = '7ABC123'), CURRENT_DATE - INTERVAL '15 days', '13:00', '15:00', 120, 'completed', 'road_test_prep', 85.00, 'excellent', 5, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),

-- Student 6 (Caleb Nguyen): withdrawn - 2 completed lessons before leaving
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-00000000000c', (SELECT id FROM vehicles WHERE license_plate = '7DEF456'), CURRENT_DATE - INTERVAL '35 days', '09:00', '11:00', 120, 'completed', 'behind_wheel', 70.00, 'needs_improvement', 3, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-00000000000c', (SELECT id FROM vehicles WHERE license_plate = '7DEF456'), CURRENT_DATE - INTERVAL '25 days', '09:00', '11:00', 120, 'completed', 'behind_wheel', 70.00, 'good', 4, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),

-- Student 7 (Priya Anand): 1 completed, 1 no_show (generates the fee flag below), 1 upcoming
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-00000000000b', (SELECT id FROM vehicles WHERE license_plate = '7XYZ789'), CURRENT_DATE - INTERVAL '14 days', '09:00', '11:00', 120, 'completed', 'behind_wheel', 70.00, 'good', 4, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
('50000000-0000-0000-0000-000000000001', '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-00000000000b', (SELECT id FROM vehicles WHERE license_plate = '7XYZ789'), CURRENT_DATE - INTERVAL '5 days', '09:00', '11:00', 120, 'no_show', 'behind_wheel', 70.00, NULL, NULL, false, 'Student did not show up', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-00000000000b', (SELECT id FROM vehicles WHERE license_plate = '7XYZ789'), CURRENT_DATE + INTERVAL '4 days', '09:00', '11:00', 120, 'scheduled', 'behind_wheel', 70.00, NULL, NULL, false, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),

-- Student 8 (Jordan Vance, adult): 2 completed, 1 upcoming
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000008', '10000000-0000-0000-0000-00000000000a', (SELECT id FROM vehicles WHERE license_plate = '7ABC123'), CURRENT_DATE - INTERVAL '18 days', '13:00', '15:00', 120, 'completed', 'behind_wheel', 70.00, 'good', 4, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000008', '10000000-0000-0000-0000-00000000000a', (SELECT id FROM vehicles WHERE license_plate = '7ABC123'), CURRENT_DATE - INTERVAL '9 days', '13:00', '15:00', 120, 'completed', 'behind_wheel', 70.00, 'excellent', 5, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000008', '10000000-0000-0000-0000-00000000000a', (SELECT id FROM vehicles WHERE license_plate = '7ABC123'), CURRENT_DATE + INTERVAL '5 days', '13:00', '15:00', 120, 'scheduled', 'road_test_prep', 85.00, NULL, NULL, false, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),

-- Student 9 (Naomi Frasier, adult, completed): 2 completed lessons before completion
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000009', '10000000-0000-0000-0000-00000000000b', (SELECT id FROM vehicles WHERE license_plate = '7XYZ789'), CURRENT_DATE - INTERVAL '85 days', '09:00', '11:00', 120, 'completed', 'behind_wheel', 70.00, 'good', 5, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
(gen_random_uuid(), '55654b9d-6d7f-46e0-ade2-be606abfe00a', '40000000-0000-0000-0000-000000000009', '10000000-0000-0000-0000-00000000000b', (SELECT id FROM vehicles WHERE license_plate = '7XYZ789'), CURRENT_DATE - INTERVAL '70 days', '09:00', '11:00', 120, 'completed', 'road_test_prep', 85.00, 'excellent', 5, true, NULL, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001');
