...
-- Purpose: Support permit issue date tracking and optional second emergency contact

-- Add permit issue date
ALTER TABLE students
  ADD COLUMN learner_permit_issue_date DATE;

-- Add second emergency contact fields
ALTER TABLE students
...
COMMENT ON COLUMN students.emergency_contact_2_name IS 'Second emergency contact name (optional)';
COMMENT ON COLUMN students.emergency_contact_2_phone IS 'Second emergency contact phone (optional)';
