...
| [PROJECT_SCHEMA_REFERENCE.md](PROJECT_SCHEMA_REFERENCE.md) | Database schema | Nov 2025 |
...
3. Check [PROJECT_SCHEMA_REFERENCE.md](PROJECT_SCHEMA_REFERENCE.md) - Database context
4. Review [DEVELOPMENT_LOG.md](DEVELOPMENT_LOG.md) - Learn from past

### "I'm implementing blockchain features"

1. Read [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) - Technical specs
2. Follow [BLOCKCHAIN_ROADMAP.md](BLOCKCHAIN_ROADMAP.md) - Implementation plan
3. Check [deployment-info.json](deployment-info.json) - LARS configuration
4. Test with `npx lars`
