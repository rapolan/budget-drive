  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="bg-status-info-bg rounded-xl p-4 border border-status-info-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-status-info-text">{weeklyStats.totalLessons}</p>
        ...
        <div className="bg-status-success-bg rounded-xl p-4 border border-status-success-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-status-success-text">{weeklyStats.openSlots}</p>
        ...
        <div className="bg-status-warning-bg rounded-xl p-4 border border-status-warning-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-status-warning-text">{weeklyStats.utilizationRate}%</p>
        ...
        <div className="bg-status-danger-bg border border-status-danger-border rounded-lg p-6">
          <div className="flex items-start">
            <div className="flex-shrink-0">
              <svg className="h-6 w-6 text-status-danger-text" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
            </div>
            <div className="ml-3 flex-1">
              <h3 className="text-sm font-medium text-status-danger-text">Failed to load schedule</h3>
              ...
              <div className="mt-4">
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-status-danger-text bg-status-danger-bg hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                >
                  Retry
                </button>
              </div>
                        ...
                        {dayLessons.length > 0 ? (
                          <div className="space-y-1">
                            ...
                            <div className="text-[10px] text-tx-muted">
                              ...
                              {completedCount > 0 && <span className="text-status-success-text">{completedCount} done</span>}
                            </div>
                          </div>
                        ) : (
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={`text-xl font-bold mt-1 ${
                          todayColumn
                            ? 'text-status-info-text bg-status-info-bg w-8 h-8 rounded-full flex items-center justify-center mx-auto'
                            : pastDay
                            ? 'text-tx-muted'
                            : 'text-tx-primary'
                        }`}>
                        ...
                        {hasCapacity && !pastDay && (
                          <div className="mt-3 px-1">
                            <div className="flex items-center justify-between text-[10px] mb-1">
                              <span className={isFull ? 'text-status-danger-text font-semibold' : 'text-tx-muted'}>
                                {capacity.booked}/{capacity.max}
                              </span>
                              <span className={
                                isFull ? 'text-status-danger-text font-semibold'
                                : capacityPercentage >= 75 ? 'text-status-warning-text'
                        ...
                        >
                          {slot.isAvailable ? (
                            ...
                            <button
                              ...
                              className="w-full rounded-lg bg-status-info-bg border-2 border-status-info-border px-3 py-3 text-center transition-all duration-200 hover:brightness-95 hover:shadow-lg hover:scale-[1.02] group"
                            >
                              ...
                              <div className="text-sm font-semibold text-status-info-text truncate">
      ...
      <div className="flex items-center justify-center gap-8 text-sm text-tx-secondary px-4 py-3 bg-surface2 rounded-xl border border-edge">
        ...
        <div className="flex items-center gap-2">
          <div className="w-5 h-5 rounded-lg bg-status-info-bg border-2 border-status-info-border"></div>
